    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asistentes', models.ManyToManyField(through='admin_user.Asistente', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Evento',
        ...
        migrations.AddField(
            ...
            name='evento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='admin_user.eventos'),
        ),
        migrations.AddField(
            model_name='asistente',
            name='usuario',
